...
Les fonctions suivantes modifient d'une manière ou d'une autre la structure temporelle d'un pattern.
Certaines d'entre elles ont des opérateurs équivalents dans la Mini Notation :
...
En dehors de la modification du temps, il existe des moyens de [Contrôler les paramètres](/functions/value-modifiers/).
