...
Il existe plusieurs fonctions qui ajoutent un retour visuel à vos motifs.
...
Vous pouvez également changer la couleur, même l'utiliser comme motif :
...
La seule différence entre les 2 est que `pianoroll` rendra le motif directement,
