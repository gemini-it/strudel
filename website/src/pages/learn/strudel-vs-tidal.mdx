...
On _pourrait_ exprimer ce pattern dans Strudel comme ceci :
...
Contrairement à Haskell, JavaScript n'a pas la capacité de définir des opérateurs infixes personnalisés, ou de changer la signification de ceux existants.
...
Notez que tous ne fonctionnent pas dans la sortie Webaudio de Strudel.
...
Le sampler de Strudel prend en charge [un sous-ensemble](/learn/samples) du sampler de Superdirt.
