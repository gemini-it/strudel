...
Tout comme [Tidal Cycles](https://tidalcycles.org/), Strudel utilise une soi-disant "Mini-Notation", qui est un langage personnalisé conçu pour écrire des motifs rythmiques en utilisant peu de texte.

## Remarque

Cette page explique l'intégralité de la syntaxe de la mini-notation.
...
Mais, cela commencera à avoir du sens à mesure que nous passerons en revue davantage d'éléments de la mini-notation.
...
Les événements avec un "?" placé après eux auront 50 % de chances d'être retirés du motif :
...
Pour récapituler ce que nous avons appris jusqu'à présent, comparez les motifs suivants :
...
Cet algorithme peut être trouvé dans de nombreux types de logiciels musicaux, et est souvent appelé séquenceur de [rythme euclidien](https://en.wikipedia.org/wiki/Euclidean_rhythm), d'après l'informaticien Godfried Toussaint.
...
Cela facilite l'écriture de motifs avec des structures rythmiques intéressantes et des variations qui sonnent toujours familières :
...
En commençant par ce `n`, pouvez-vous faire une _chaîne de motif_ qui utilise chaque élément de mini-notation ci-dessus ?
