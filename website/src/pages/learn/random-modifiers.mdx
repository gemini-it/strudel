---
title: Modificateurs aléatoires
...
Ces méthodes ajoutent un comportement aléatoire à vos Patterns.
...
Ensuite : [Modificateurs conditionnels](/learn/conditional-modifiers)
