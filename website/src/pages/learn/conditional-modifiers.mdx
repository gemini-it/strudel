---
title: Modificateurs d'actions conditionnelles
...
# Modificateurs d'actions conditionnelles
...
Après les modificateurs d'actions conditionnelles, voyons ce que les [modificateurs d'accumulation](/learn/accumulation) ont à offrir.
