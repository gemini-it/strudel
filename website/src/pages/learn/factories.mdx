...
Les fonctions suivantes retourneront un pattern.
Ce sont les équivalents utilisés par la Mini Notation :
...
Après les Constructeurs de Patterns, voyons quels [Modificateurs de temps](/learn/time-modifiers) sont disponibles.
