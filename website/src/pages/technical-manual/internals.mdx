...
Ces fonctions sont de plus bas niveau, probablement pas nécessaires pour le live codeur.

# Opérations de foncteur, applicative et monadique de style Haskell
...
# Méthodes utilitaires principalement pour usage interne
